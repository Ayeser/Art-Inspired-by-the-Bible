$(document).ready(function () {
    ...
    function makeNewTestamentNav() {
        ...
        $("#nav3").remove();
        $("#nav4").remove();
        $("#nav1").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav2"><a class="nav-link" href="#" id="GospelsNav">Gospels/Acts</a><a class="nav-link" href="#" id="PaulineEpistlesNav">Pauline Epistles</a><a class="nav-link" href="#" id="GeneralEpistlesNav">General Epistles</a><a class="nav-link" href="#" id="RevelationNav">Revelation</a></nav></nav>');
    ...
    function choseWisdomBooks() {
        ...
        $("#nav3").remove();
        $("#nav4").remove();
        $("#nav2").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav3"><a class="nav-link" href="#" id="Job">Job</a><a class="nav-link" href="#" id="Psalms">Psalms</a><a class="nav-link" href="#" id="Proverbs">Proverbs</a><a class="nav-link" href="#" id="Ecclesiastes">Ecclesiastes</a><a class="nav-link" href="#" id="SongOfSolomon">Song of Solomon</a></nav>');
    ...
    function choseMajorProphetsBooks() {
        ...
        $("#nav3").remove();
        $("#nav4").remove();
        $("#nav2").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav3"><a class="nav-link" href="#" id="Isaiah">Isaiah</a><a class="nav-link" href="#" id="Jeremiah">Jeremiah</a><a class="nav-link" href="#" id="Lamentations">Lamentations</a><a class="nav-link" href="#" id="Ezekiel">Ezekiel</a><a class="nav-link" href="#" id="Daniel">Daniel</a></nav>');
    ...
    function choseMinorProphetsBooks() {
        ...
        $("#nav3").remove();
        $("#nav4").remove();
        $("#nav2").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav3"><a class="nav-link" href="#" id="Hosea">Hosea</a><a class="nav-link" href="#" id="Joel">Joel</a><a class="nav-link" href="#" id="Amos">Amos</a><a class="nav-link" href="#" id="Obadiah">Obadiah</a><a class="nav-link" href="#" id="Jonah">Jonah</a><a class="nav-link" href="#" id="Micah">Micah</a><a class="nav-link" href="#" id="Nahum">Nahum</a><a class="nav-link" href="#" id="Habakkuk">Habakkuk</a><a class="nav-link" href="#" id="Zephaniah">Zephaniah</a><a class="nav-link" href="#" id="Haggai">Haggai</a><a class="nav-link" href="#" id="Zechariah">Zechariah</a><a class="nav-link" href="#" id="Malachi">Malachi</a></nav>');
    ...
    function choseGospelsBooks() {
        ...
        $("#nav3").remove();
        $("#nav4").remove();
        $("#nav2").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav3"><a class="nav-link" href="#" id="Matthew">Matthew</a><a class="nav-link" href="#" id="Mark">Mark</a><a class="nav-link" href="#" id="Luke">Luke</a><a class="nav-link" href="#" id="John">John</a><a class="nav-link" href="#" id="Acts">Acts</a></nav>');
    ...
    function chosePaulineBooks() {
        ...
        $("#nav3").remove();
        $("#nav4").remove();
        $("#nav2").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav3"><a class="nav-link" href="#" id="Romans">Romans</a><a class="nav-link" href="#" id="FirstCorinthians">1 Corinthians</a><a class="nav-link" href="#" id="SecondCorinthians">2 Corinthians</a><a class="nav-link" href="#" id="Galatians">Galatians</a><a class="nav-link" href="#" id="Ephesians">Ephesians</a><a class="nav-link" href="#" id="Philippians">Philippians</a><a class="nav-link" href="#" id="Colossians">Colossians</a><a class="nav-link" href="#" id="FirstThessalonians">1 Thessalonians</a><a class="nav-link" href="#" id="SecondThessalonians">2 Thessalonians</a><a class="nav-link" href="#" id="FirstTimothy">1 Timothy</a><a class="nav-link" href="#" id="SecondTimothy">2 Timothy</a><a class="nav-link" href="#" id="Titus">Titus</a><a class="nav-link" href="#" id="Philemon">Philemon</a></nav>');
    ...
    function choseRevelationBook() {
        event.preventDefault();
    $("#nav3").remove();
    $("#nav2").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav3"></nav>');
    for (i = 1; i < 23; i++) {
        $("#nav3").append('<a class="nav-link" href="#" id="rev" chapNumber="' + i + '">' + i + '</a>');
    };
};
...
$(document).on("click", ".rev", function () { searchTerms = ["revelation", this.chapNumber]; handleArtworkFormSubmit(event); });
    ...
    function choseGenesis() {
        event.preventDefault();
        $("#nav4").remove();
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 51; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="gen" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseExodus() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 41; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Ex" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseLeviticus() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 29; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Lev" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseNumbers() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 37; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Num" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseDeuteronomy() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 35; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Deut" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJoshua() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 25; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Josh" chapNumber="' + i + '">' + i + '</button>');
        };
    };
    ...
    function choseJudges() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 22; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Judge" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseRuth() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row  navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 5; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Rut" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstSamuel() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 32; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FSam" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondSamuel() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 25; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SSam" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstKings() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 23; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FKin" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondKings() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 26; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SKin" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstChronicles() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 30; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FChron" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondChronicles() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 37; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SChron" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseEzra() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 11; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Ezr" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseNehemiah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 14; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Neh" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseEsther() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 11; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Esth" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJob() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 43; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Jo" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function chosePsalms() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 151; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Psa" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseProverbs() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 32; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Prov" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseEcclesiastes() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 13; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Eccl" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSongofSolomon() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 9; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SoS" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseIsaiah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 67; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Isa" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJeremiah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 53; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Jer" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseLamentations() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 6; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Lam" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseEzekiel() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 49; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Eze" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseDaniel() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 13; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Dan" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseHosea() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 15; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Hos" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJoel() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Joe" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseAmos() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 10; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Amo" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseObadiah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 2; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Oba" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJonah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 5; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Jona" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseMicah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 8; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Mic" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseNahum() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Nah" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseHabakkuk() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Hab" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseZephaniah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Zeph" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseHaggai() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 3; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Hag" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseZechariah() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 15; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Zech" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseMalachi() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 5; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Mala" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseMatthew() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 29; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Matt" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseMark() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 17; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Mar" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseLuke() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 25; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Luk" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJohn() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 22; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Joh" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseActs() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 29; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Act" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseRomans() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 17; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Rom" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstCorinthians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 17; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FCor" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondCorinthians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 14; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SCor" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseGalatians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 7; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Gal" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseEphesians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 7; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Eph" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function chosePhilippians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 5; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Phil" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseColossians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 5; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Col" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstThessalonians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 6; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FThes" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondThessalonians() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SThes" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstTimothy() {
        event.preventDefault();
        $("#nav4").remove();
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-light bg-light justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 7; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FTim" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondTimothy() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 5; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="STim" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseTitus() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Tit" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function chosePhilemon() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 2; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="phile" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseHebrews() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 14; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="heb" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJames() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 6; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="jam" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstPeter() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 6; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FPet" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondPeter() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 4; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SPet" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseFirstJohn() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 6; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="FJohn" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseSecondJohn() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 2; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="SJohn" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseThirdJohn() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 2; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="TJohn" chapNumber="' + i + '">' + i + '</a>');
        };
    };
    ...
    function choseJude() {
        ...
        $("#nav3").show(400).after('<nav class="container-fluid row navbar navbar-expand-lg navbar-dark bg-dark justify-content-between rounded" id="nav4"></nav>');
        for (i = 1; i < 2; i++) {
            $("#nav4").append('<a class="nav-link" href="#" id="Jud" chapNumber="' + i + '">' + i + '</a>');
        };
    };
...
// this next function searches the Bible with a Biblebook Chapter inputted.
    ...
    function createNewPiece(piece) {
        event.preventDefault();
        return ('<div class="col-sm-3 card"><h5 class="card-title">' + piece.title + '</h3><img class="img-responsive" src="' + piece.picture + '"><p>Artist: ' + piece.artist + '</p><p>Book: ' + piece.book + '</p><p>Verse: ' + piece.verse + '</p></div>');
    }

    function createNewVideo(piece) {
        event.preventDefault();
        return ('<div class="col-sm-3 card"><h5 class="card-title">' + piece.title + '</h5><p>Artist: ' + piece.sourceCreator + '</p><p>Book: ' + piece.book + '</p><p>Verse: ' + piece.verse + '</p><div>' + piece.videoEmbed + '</div></div>');
    }
